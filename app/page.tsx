...
const data = {
  manifest: [ {text:"I am worthy of deep, unconditional love — starting with my own.", img:"https://images.pexels.com/photos/417074/pexels-photo-417074.jpeg?auto=compress&w=800"}, {text:"My body is a sacred vessel. I honor it with movement that feels like joy.", img:"https://images.pexels.com/photos/38238/maldives-ile-beach-sun-38238.jpg?auto=compress&w=800"}, {text:"I release the need for external validation. I am enough exactly as I am.", img:"https://images.pexels.com/photos/35537/pexels-photo.jpg?auto=compress&w=800"}, ],
  motivate: [ {text:"What would you do if you knew you could not fail?", img:"https://images.pexels.com/photos/4145190/pexels-photo-4145190.jpeg?auto=compress&w=800"}, {text:"Your dreams chose you for a reason."}, {text:"Dare to name what you really want."}, ],
  'Music/Dance': [ {text:"How does dancing reset your nervous system?", img:"https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&w=800"}, {text:"What music makes you feel most alive?"}, ],
  nature: [ {text:"How does being in nature shift your sense of self?", img:"https://images.pexels.com/photos/414144/pexels-photo-414144.jpeg?auto=compress&w=800"}, {text:"What does nature teach you about growth?"}, ],
  fitness: [ {text:"What does your body want to express through movement today?", img:"https://images.pexels.com/photos/416778/pexels-photo-416778.jpeg?auto=compress&w=800"}, {text:"How can you honor your body as a vessel of strength?"}, ],
  food: [ {text:"What does it mean to nourish yourself with love?", img:"https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&w=800"}, {text:"How can eating become a sacred act of self-care?"}, ],
  selfcare: [ {text:"What self-care ritual makes you feel most loved?", img:"https://images.pexels.com/photos/3997982/pexels-photo-3997982.jpeg?auto=compress&w=800"}, {text:"How can you turn self-care into a non-negotiable?"}, ],
  rituals: [ {text:"How can skincare become a ritual of self-love?", img:"https://images.pexels.com/photos/3985328/pexels-photo-3985328.jpeg?auto=compress&w=800"}, {text:"What is the power of flowers and softness?"}, ],
...
export default function App() {
  ...
  const shuffle = (tab: string) => {
    if(!isPaid) { alert("Unlock the full experience to get more prompts ✨"); return }
      ...
      {!started? (
        <div style={{position:'relative',height:'100vh'}}>
          ...
          <div style={{position:'relative',zIndex:10,height:'100%',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',textAlign:'center',padding:'24px'}}>
            ...
            {!isPaid && <button className="btn" style={{marginTop:'12px', background:'#059669'}} onClick={()=>setIsPaid(true)}>Unlock Full Access - $19</button>}
          </div>
        </div>
      ) : (
            ...
            {['manifest','motivate','Music/Dance','nature','fitness','food','selfcare','rituals'].map(tab=>(
              <div key={tab} className={`panel ${activeTab===tab?'active':''}`}>
                <div className="card" style={{position:'relative'}}>
                  ...
                  <button className={`btn ${!isPaid? 'btn-locked' : ''}`} onClick={()=>shuffle(tab)}>Shuffle</button>
                  {!isPaid && <div className="overlay"><p>Unlock all {(data[tab as keyof typeof data] as any[]).length} prompts</p><button className="btn" onClick={()=>setIsPaid(true)}>Unlock $19</button></div>}
                </div>
              </div>
            ))}
