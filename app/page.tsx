...
const data = {
  ...
  motivate: Array.from({length:28}, (_,i)=>({text:["What would you do if you knew you could not fail?","Your dreams chose you for a reason.","Dare to name what you really want.","What is one brave step you can take today?","You are capable of more than you think.","Motivation is action. Move anyway.","What would your future self thank you for?","Progress, not perfection.","You are allowed to want more.","Discipline is self-love in action.","Your only competition is who you were yesterday.","Start before you feel ready.","What if it all works out?","You have survived 100% of your hard days.","Do it scared.","Your time is now.","What story are you telling yourself? Rewrite it.","Show up for yourself today.","You are building the life you deserve.","Small steps every day.","You are not lazy. You are learning.","What lights you up? Do that.","You are worthy of your goals.","Keep going. You’re closer than you think.","Be your own biggest cheerleader.","What would love do?","You are creating your reality.","You did it. Now do it again for you."][i], img:["https://images.pexels.com/photos/4145190/pexels-photo-4145190.jpeg?auto=compress&w=800","https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&w=800","https://images.pexels.com/photos/414144/pexels-photo-414144.jpeg?auto=compress&w=800","https://images.pexels.com/photos/416778/pexels-photo-416778.jpeg?auto=compress&w=800"][Math.floor(i/7)]})),
  'Music/Dance': Array.from({length:28}, (_,i)=>({text:["How does dancing reset your nervous system?","What music makes you feel most alive?","Let your body move however it needs to.","What song is your current anthem?","Dance like no one is watching. Because they aren't.","How does rhythm help you feel grounded?","Create a playlist for your healing.","What does your body want to express through music?","Sing loud. Even if you're off key.","Music is medicine. What do you need today?","Move your hips. Release what you hold.","What song reminds you of your power?","Let sound wash over you.","Dance out the emotions you can't name.","What music makes you feel safe?","Your body knows how to move. Trust it.","Play the song that makes you cry. Feel it.","What beat matches your heartbeat?","Music connects you to your soul.","Have a 5-minute dance party for yourself.","What lyrics feel like they were written for you?","Let music be your prayer.","Move in a way that feels like love.","What song would you play at your celebration?","Sound bath. Close your eyes and listen.","How does music help you process?","Create the soundtrack to your life.","You are the music you've been waiting for."][i], img:["https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&w=800","https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&w=800","https://images.pexels.com/photos/3997982/pexels-photo-3997982.jpeg?auto=compress&w=800","https://images.pexels.com/photos/3985328/pexels-photo-3985328.jpeg?auto=compress&w=800"][Math.floor(i/7)]})),
  nature: Array.from({length:28}, (_,i)=>({text:`Day ${i+1}: How does being in nature shift your sense of self?`, img:["https://images.pexels.com/photos/414144/pexels-photo-414144.jpeg?auto=compress&w=800","https://images.pexels.com/photos/417074/pexels-photo-417074.jpeg?auto=compress&w=800","https://images.pexels.com/photos/38238/maldives-ile-beach-sun-38238.jpg?auto=compress&w=800","https://images.pexels.com/photos/35537/pexels-photo.jpg?auto=compress&w=800"][Math.floor(i/7)]})),
  fitness: Array.from({length:28}, (_,i)=>({text:`Day ${i+1}: What does your body want to express through movement today?`, img:["https://images.pexels.com/photos/416778/pexels-photo-416778.jpeg?auto=compress&w=800","https://images.pexels.com/photos/4145190/pexels-photo-4145190.jpeg?auto=compress&w=800","https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&w=800","https://images.pexels.com/photos/414144/pexels-photo-414144.jpeg?auto=compress&w=800"][Math.floor(i/7)]})),
  food: Array.from({length:28}, (_,i)=>({text:`Day ${i+1}: What does it mean to nourish yourself with love?`, img:["https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&w=800","https://images.pexels.com/photos/3997982/pexels-photo-3997982.jpeg?auto=compress&w=800","https://images.pexels.com/photos/3985328/pexels-photo-3985328.jpeg?auto=compress&w=800","https://images.pexels.com/photos/417074/pexels-photo-417074.jpeg?auto=compress&w=800"][Math.floor(i/7)]})),
  selfcare: Array.from({length:28}, (_,i)=>({text:`Day ${i+1}: What self-care ritual makes you feel most loved?`, img:["https://images.pexels.com/photos/3997982/pexels-photo-3997982.jpeg?auto=compress&w=800","https://images.pexels.com/photos/3985328/pexels-photo-3985328.jpeg?auto=compress&w=800","https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&w=800","https://images.pexels.com/photos/416778/pexels-photo-416778.jpeg?auto=compress&w=800"][Math.floor(i/7)]})),
  rituals: Array.from({length:28}, (_,i)=>({text:`Day ${i+1}: How can skincare become a ritual of self-love?`, img:["https://images.pexels.com/photos/3985328/pexels-photo-3985328.jpeg?auto=compress&w=800","https://images.pexels.com/photos/3997982/pexels-photo-3997982.jpeg?auto=compress&w=800","https://images.pexels.com/photos/414144/pexels-photo-414144.jpeg?auto=compress&w=800","https://images.pexels.com/photos/4145190/pexels-photo-4145190.jpeg?auto=compress&w=800"][Math.floor(i/7)]})),
  journal: ["Describe the version of yourself you are becoming.", "Write a love letter to yourself.", "What dream have you been too afraid to chase?","What does self-love feel like in your body?","What are you ready to release?","What are you calling in?","How can you be gentler with yourself?","What makes you feel safe?","What does your heart need today?","What are you proud of?","What does joy look like for you?","What boundary do you need?","What does healing require?","What does peace feel like?","What are you grateful for?","What does your soul need?","How can you honor yourself?","What does abundance mean to you?","What are you becoming?","What does pleasure feel like?","What does strength feel like?","What does softness feel like?","What does truth feel like?","What does home feel like?","What does love feel like?","What does wholeness feel like?","What does freedom feel like?","Dear Me, I love you because..."],
  writings: []
}
...
export default function App() {
  ...
  const shuffle = (tab: string) => { const arr = data[tab as keyof typeof data] as any[]; setIndex({...index, [tab]: (index[tab] + 1) % arr.length }) }
